      ...
      <div class="registration-body">
        <form ref="secondStep">
          ...
          <div class="registration-item">
              ...
              <input type="text" class="registration-input" ref="country" placeholder="Страна" >
          </div>!-->
          <div class="registration-item">
          ...
          <div class="registration-item">
            <button
              id="chooseAvaButton"
              type="button"
              @click="chooseAvatarButton($event)">{{$lang.variables.addAvatar}}*
            </button>
          </div>
          <div
            id="reg-crop"
            ...
            <div class="cropp">
              ...
              <button
                type="button"
                @click="myCroppa.remove()">{{$lang.variables.delete}}
              </button>
              <button
                type="button"
          ...
          <div class="registration-item">
            ...
            <select
              ...
              @change="addToSocialStatus()">
              <option
                v-for="(option,i) in socialOptions"
          ...
          <div class="registration-item">
                            <span
                              ...
                              :key="index">
                                    <span v-text="social"></span><i
                              @click="deleteFromSocial(index)"
          ...
          <div class="registration-item">
            ...
            <select
              ...
              @change="addToActivity()">

              <option
                v-for="(option,i) in fieldOfActivity"
                v-bind:value="option.value"
                :key="i">
                {{ option.text }}
              </option>
          ...
          <div class="registration-item">
                            <span
                              ...
                              :key="index">
                                    <span v-text="activity"></span><i
                              @click="deleteFromActivity(index)"
                              class="icon-delete-f"></i>
                            </span>
          </div>
